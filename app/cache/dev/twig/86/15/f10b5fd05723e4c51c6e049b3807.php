...
/* WebProfiler:Collector:timer.html.twig */
class __TwigTemplate_8615f10b5fd05723e4c51c6e049b3807 extends Twig_Template
{
    protected $parent;
    ...
    ";
        ...
        // line 8
        echo "        ";
        echo twig_escape_filter($this->env, sprintf("%.0f", ($this->getAttribute($this->getContext($context, 'collector', '8'), "time", array(), "any", false, 8) * 1000)), "html");
        echo " ms
    ";
    ...
    {
        return "WebProfiler:Collector:timer.html.twig";
    }
}
