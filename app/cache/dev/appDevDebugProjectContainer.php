...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/hanks/ptuit/Symfony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Framework', '/home/hanks/ptuit/Symfony/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Security', '/home/hanks/ptuit/Symfony/vendor/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Twig', '/home/hanks/ptuit/Symfony/vendor/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Swiftmailer', '/home/hanks/ptuit/Symfony/vendor/symfony/src/Symfony/Bundle/SwiftmailerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Doctrine', '/home/hanks/ptuit/Symfony/vendor/symfony/src/Symfony/Bundle/DoctrineBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Ptuit', '/home/hanks/ptuit/Symfony/src/Ptuit/PtuitBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebProfiler', '/home/hanks/ptuit/Symfony/vendor/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SymfonyWebConfigurator', '/home/hanks/ptuit/Symfony/vendor/bundles/Symfony/Bundle/WebConfiguratorBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/home/hanks/ptuit/Symfony/app/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
    ...
    /**
     * Gets the 'assetic.filter.closure.api' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getAssetic_Filter_Closure_ApiService()
    {
        return $this->services['assetic.filter.closure.api'] = new \Assetic\Filter\GoogleClosure\CompilerApiFilter();
    }
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'closure' => 'assetic.filter.closure.api'));
    }
    ...
    {
        return $this->services['debug.toolbar'] = new \Symfony\Bundle\WebProfilerBundle\WebDebugToolbarListener($this->get('templating'), false);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'ptuit', 'host' => 'localhost', 'user' => 'ptuit', 'password' => 'ptuit', 'driver' => 'pdo_mysql', 'port' => NULL, 'driverOptions' => array()), $a, new \Doctrine\Common\EventManager());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_21da210962f85c54b55a22369c616480');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_21da210962f85c54b55a22369c616480');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_21da210962f85c54b55a22369c616480');

        $d = new \Doctrine\Common\Annotations\AnnotationReader();
        $d->setAnnotationNamespaceAlias('Doctrine\\ORM\\Mapping\\', 'orm');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, array(0 => '/home/hanks/ptuit/Symfony/src/Ptuit/PtuitBundle/Entity')), 'Ptuit\\PtuitBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('Ptuit' => 'Ptuit\\PtuitBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/home/hanks/ptuit/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        $this->services['event_dispatcher'] = $instance = new \Symfony\Bundle\FrameworkBundle\Debug\TraceableEventDispatcher($this, $this->get('logger'));
        ...
        $instance->addListenerService('onCoreResponse', 'debug.toolbar', -128);
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\CsrfProvider\SessionCsrfProvider($this->get('session'), 'd510ce48264b4f98336865a18e730997f');
    }
    ...
    {
        return $this->services['http_kernel'] = new \Symfony\Bundle\FrameworkBundle\HttpKernel($this->get('event_dispatcher'), $this, new \Symfony\Bundle\FrameworkBundle\Controller\ControllerResolver($this, $this->get('controller_name_converter'), $this->get('logger')));
    }
    ...
    protected function getLoggerService()
    {
        ...
        $b = new \Zend\Log\Writer\Stream('/home/hanks/ptuit/Symfony/app/logs/dev.log');
        $b->addFilter($a);
...
'));
    ...
    {
        require_once '/home/hanks/ptuit/Symfony/vendor/swiftmailer/lib/swift_init.php';
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add($this->get('data_collector.swiftmailer'));
    ...
    {
        return $this->services['router.cached'] = new \Symfony\Bundle\FrameworkBundle\Routing\CachedRouter('/home/hanks/ptuit/Symfony/app/cache/dev', 'appdevUrlMatcher', 'appdevUrlGenerator');
    }
    ...
    {
        return $this->services['router.real'] = new \Symfony\Component\Routing\Router(new \Symfony\Bundle\FrameworkBundle\Routing\LazyLoader($this, 'routing.loader.real'), '/home/hanks/ptuit/Symfony/app/config/routing_dev.yml', array('cache_dir' => '/home/hanks/ptuit/Symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_base_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'resource_type' => ''));
    }
    ...
    {
        return $this->services['symfony.webconfigurator'] = new \Symfony\Bundle\WebConfiguratorBundle\Configurator('/home/hanks/ptuit/Symfony/app');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper('', '/home/hanks/ptuit/Symfony/app');
    }
    ...
    {
        $this->services['translator.real'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => '/home/hanks/ptuit/Symfony/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => '/home/hanks/ptuit/Symfony/app/cache/dev/twig', 'charset' => 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\FormExtension(array(0 => 'Twig::form.html.twig')));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), '/home/hanks/ptuit/Symfony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/hanks/ptuit/Symfony/app/cache/dev/assetic/assets');
    }
    ...
    /**
     * Gets the 'data_collector.swiftmailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDataCollector_SwiftmailerService()
    {
        return $this->services['data_collector.swiftmailer'] = new \Symfony\Bundle\SwiftmailerBundle\DataCollector\MessageDataCollector($this->get('swiftmailer.plugin.messagelogger'), $this->get('mailer'));
    }
    ...
    {
        return $this->services['profiler.storage'] = new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:/home/hanks/ptuit/Symfony/app/cache/dev/profiler.db', '', '', 86400);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/hanks/ptuit/Symfony/app/Resources');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader(array('validation' => 'Symfony\\Component\\Validator\\Constraints\\')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader('loadValidatorMetadata'), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/hanks/ptuit/Symfony/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/DependencyInjection/../../../Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))));
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/hanks/ptuit/Symfony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/hanks/ptuit/Symfony/app/cache/dev',
            'kernel.logs_dir' => '/home/hanks/ptuit/Symfony/app/logs',
            'kernel.bundles' => array(
                ...
                'Zend' => 'Symfony\\Bundle\\ZendBundle\\ZendBundle',
                'Swiftmailer' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle',
                'Doctrine' => 'Symfony\\Bundle\\DoctrineBundle\\DoctrineBundle',
                'Assetic' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle',
                'SensioFrameworkExtra' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle',
                'JMSSecurityExtra' => 'JMS\\SecurityExtraBundle\\JMSSecurityExtraBundle',
                'Ptuit' => 'Ptuit\\PtuitBundle\\PtuitBundle',
                'WebProfiler' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle',
                'SymfonyWebConfigurator' => 'Symfony\\Bundle\\WebConfiguratorBundle\\SymfonyWebConfiguratorBundle',
            ),
            ...
            'database_name' => 'ptuit',
            'database_user' => 'ptuit',
            'database_password' => 'ptuit',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'localhost',
            'mailer_user' => '',
            'mailer_password' => '',
            'locale' => 'en',
            'csrf_secret' => 'd510ce48264b4f98336865a18e730997f',
            ...
            'form.csrf_protection.secret' => 'd510ce48264b4f98336865a18e730997f',
            ...
            'routing.resource' => '/home/hanks/ptuit/Symfony/app/config/routing_dev.yml',
            ...
            'security.context.always_authenticate' => false,
            ...
            'twig.form.resources' => array(
                0 => 'Twig::form.html.twig',
            ),
            'twig.options' => array(
                'debug' => true,
                'strict_variables' => true,
                'cache' => '/home/hanks/ptuit/Symfony/app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
...
',
            ...
            'zend.logger.path' => '/home/hanks/ptuit/Symfony/app/logs/dev.log',
            'swiftmailer.class' => 'Swift_Mailer',
            'swiftmailer.transport.sendmail.class' => 'Swift_Transport_SendmailTransport',
            'swiftmailer.transport.mail.class' => 'Swift_Transport_MailTransport',
            'swiftmailer.transport.failover.class' => 'Swift_Transport_FailoverTransport',
            'swiftmailer.init_file' => '/home/hanks/ptuit/Symfony/vendor/swiftmailer/lib/swift_init.php',
            ...
            'swiftmailer.base_dir' => '/home/hanks/ptuit/Symfony/vendor/swiftmailer/lib',
            ...
            'doctrine.orm.proxy_dir' => '/home/hanks/ptuit/Symfony/app/cache/dev/doctrine/orm/Proxies',
            ...
            'assetic.closure.jar' => NULL,
            'assetic.java.bin' => NULL,
            'assetic.node.bin' => NULL,
            'assetic.node.paths' => array(

            ),
            'assetic.sass.bin' => NULL,
            'assetic.yui.jar' => NULL,
            'assetic.cache_dir' => '/home/hanks/ptuit/Symfony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/hanks/ptuit/Symfony/app/../web',
            'assetic.write_to' => '/home/hanks/ptuit/Symfony/app/../web',
            ...
            'assetic.filter.closure.java' => NULL,
            'assetic.filter.closure.jar' => NULL,
            ...
            'data_collector.templates' => array(
                'data_collector.config' => array(
                    0 => 'config',
                    1 => 'WebProfiler:Collector:config',
                ),
                'data_collector.request' => array(
                    0 => 'request',
                    1 => 'WebProfiler:Collector:request',
                ),
                'data_collector.exception' => array(
                    0 => 'exception',
                    1 => 'WebProfiler:Collector:exception',
                ),
                'data_collector.events' => array(
                    0 => 'events',
                    1 => 'WebProfiler:Collector:events',
                ),
                'data_collector.logger' => array(
                    0 => 'logger',
                    1 => 'WebProfiler:Collector:logger',
                ),
                'data_collector.timer' => array(
                    0 => 'timer',
                    1 => 'WebProfiler:Collector:timer',
                ),
                'data_collector.memory' => array(
                    0 => 'memory',
                    1 => 'WebProfiler:Collector:memory',
                ),
                'data_collector.security' => array(
                    0 => 'security',
                    1 => 'Security:Collector:security',
                ),
                'data_collector.swiftmailer' => array(
                    0 => 'swiftmailer',
                    1 => 'Swiftmailer:Collector:swiftmailer',
                ),
                'data_collector.doctrine' => array(
                    0 => 'db',
                    1 => 'Doctrine:Collector:db',
                ),
            ),
            'kernel.compiled_classes' => array(
                ...
                68 => 'Zend\\Log\\Factory',
                69 => 'Zend\\Log\\Filter',
                70 => 'Zend\\Log\\Filter\\AbstractFilter',
                71 => 'Zend\\Log\\Filter\\Priority',
                72 => 'Zend\\Log\\Formatter',
                73 => 'Zend\\Log\\Formatter\\Simple',
                74 => 'Zend\\Log\\Logger',
                75 => 'Zend\\Log\\Writer',
                76 => 'Zend\\Log\\Writer\\AbstractWriter',
                77 => 'Zend\\Log\\Writer\\Stream',
                78 => 'Symfony\\Bundle\\ZendBundle\\Logger\\DebugLogger',
                79 => 'Symfony\\Bundle\\ZendBundle\\Logger\\Logger',
                80 => 'JMS\\SecurityExtraBundle\\Controller\\ControllerListener',
                81 => 'JMS\\SecurityExtraBundle\\Mapping\\Driver\\AnnotationParser',
                82 => 'JMS\\SecurityExtraBundle\\Mapping\\Driver\\AnnotationConverter',
                83 => 'JMS\\SecurityExtraBundle\\Security\\Authorization\\Interception\\MethodInvocation',
            ),
